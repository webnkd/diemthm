function checkSdt() {
  ...
  var sdtReg = /0[0-9]{9}/;
  if (sdtReg.test(sdt)) {
    document.getElementById("sdt").style.color = "blue";
  } else {
    alert("Số điện thoại 0... ");
...
function checkNumber() {
  ...
  if (isNaN(dtoan) || dtoan < 0 || dtoan > 10) {
  ...
  if (isNaN(dsinh) || dsinh < 0 || dsinh > 10) {
  ...
  if (isNaN(dgdcd) || dgdcd < 0 || dgdcd > 10) {
...
function Reset() {
  ...
  document.getElementById("A001").innerText = "";
  document.getElementById("A002").innerText = "";
  document.getElementById("A011").innerText = "";
  document.getElementById("A012").innerText = "";
  document.getElementById("B001").innerText = "";
  document.getElementById("B002").innerText = "";
  document.getElementById("C001").innerText = "";
  document.getElementById("C002").innerText = "";
  document.getElementById("C011").innerText = "";
  document.getElementById("C012").innerText = "";
  document.getElementById("C021").innerText = "";
  document.getElementById("C022").innerText = "";
  document.getElementById("C081").innerText = "";
  document.getElementById("C082").innerText = "";
  document.getElementById("D011").innerText = "";
  document.getElementById("D012").innerText = "";
  document.getElementById("D071").innerText = "";
  document.getElementById("D072").innerText = "";
  document.getElementById("D141").innerText = "";
  document.getElementById("D142").innerText = "";
  document.getElementById("D151").innerText = "";
  document.getElementById("D152").innerText = "";
  document.getElementById("D901").innerText = "";
  document.getElementById("D902").innerText = "";
  document.getElementById("D961").innerText = "";
  document.getElementById("D962").innerText = "";
}
